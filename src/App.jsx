...
>
  <div className="max-w-7xl mx-auto px-6">
    ...
    >
      <Pcart image={p1} title="Bural oil" link="https://burakoil.netlify.app/"/>
      <Pcart image={p2} title="Bural oil" link="https://velvety-custard-6c08d5.netlify.app/"/>
      <Pcart image={p3} title="Bural oil" link="https://dreamy-arithmetic-4809b9.netlify.app/"/>
      <Pcart image={p4} title="Bural oil" link="https://burakoil.netlify.app/"/>
      <Pcart image={p5} title="Bural oil" link="https://burakoil.netlify.app/"/>
      <Pcart image={p6} title="Bural oil" link="https://emonnote.netlify.app/"/>
    ...
    >
      ...
      <footer className="py-12 max-w-7xl mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-4 border-t border-slate-950 text-xs text-slate-400 font-mono">
        ...
        <div className="flex gap-5">
          <a href="https://github.com/FDR-sahin"  target="_blank"
